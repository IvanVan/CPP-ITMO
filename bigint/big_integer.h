...
struct big_integer {
	...
	big_integer(int a);
	big_integer(std::vector<unsigned int> const&, bool);
...
private:
	...
	void mul_vector_by_const(std::vector<unsigned int>& res, std::vector<unsigned int> const & a, unsigned int const& b);
